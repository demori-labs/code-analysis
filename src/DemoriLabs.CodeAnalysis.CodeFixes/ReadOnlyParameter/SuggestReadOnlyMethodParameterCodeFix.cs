...
[Shared]
public sealed class SuggestReadOnlyMethodParameterCodeFix : CodeFixProvider
{
    /// <inheritdoc />
    public override ImmutableArray<string> FixableDiagnosticIds => [RuleIdentifiers.SuggestReadOnlyMethodParameter];
